...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("DatePiker and ColorPiker");
        ...
        confirmButton.setOnAction(e -> {
            ...
            if (selectedDate != null && selectedColor != null) {
                ...
                selectedDateText.setText("Fecha seleccionada: " + formattedDate);

                String colorName = getColorName(selectedColor);
                selectedColorText.setText("Color seleccionado: " + colorName);
            } else {
                selectedDateText.setText("Por favor selecciona una fecha y un color que deseas!!:");
                selectedColorText.setText("");
            }
        });

        // Para la disposición vertical (VBox)
